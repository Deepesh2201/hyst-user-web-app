...
class UserController extends GetxController implements GetxService {
  ...
  Future submitStoreRatings(UserInfoModel updatedUserModel, ratings, description, storeId) async {
    _isLoading = true;
    update();

    Response response = await userRepo.storereviewsratings(updatedUserModel, ratings, description, storeId);
    _isLoading = false;
    if (response.statusCode == 200) {
