...
Future<Map<String, Map<String, String>>> init() async {
  ...
  Get.put(StoreRepo(sharedPreferences: Get.find(), apiClient: Get.find()));
  ...
  Get.lazyPut(() => CustomBannerController(bannerRepo: Get.find()));
  Get.lazyPut(() => CategoryController(categoryRepo: Get.find()));
  // Get.lazyPut(() => ItemController(itemRepo: Get.find()));
  // Get.lazyPut(() => CartController(cartRepo: Get.find()));
  Get.lazyPut(() => StoreController(storeRepo: Get.find()));
  Get.lazyPut(() => PostsController(storeRepo: Get.find()));
  Get.lazyPut(() => JobsController(storeRepo: Get.find()));
