...
import 'package:sixam_mart/view/screens/auth/store_registration_screen_update.dart';
...
import 'package:sixam_mart/view/screens/location/area_screen.dart';
import 'package:sixam_mart/view/screens/location/city_area_screen.dart';
...
import 'package:sixam_mart/view/screens/rentandsalesposts/post_list_screen.dart';
...
import 'package:sixam_mart/view/screens/store/registered_stores_screen.dart';
...
import 'package:sixam_mart/view/screens/store/webview_screen.dart';
import 'package:sixam_mart/view/screens/rentandsalesposts/post_create_screen.dart';

import '../view/screens/jobposts/job_create_screen.dart';
import '../view/screens/jobposts/job_list_screen.dart';
...
class RouteHelper {
  ...
  static const String allRegisteredStores = '/all-registered-stores';
  ...
  static const String webView = '/webview'; // Add this line to define the route
  ...
  // static String goToWebView() => webView;
  // Define the 'goToWebView' method to navigate to the WebView screen
  // static void goToWebView({required String webTitle, required String webUrl}) {
  //   Get.toNamed('$webView?webTitle=$webTitle&webUrl=$webUrl');
  // }
  ...
  static String getCityAreaRoute(String page) => '$cityArea?page=$page';
  static String getAreaRoute(String page) => '$area?page=$page';
  ...
  static String getPostRoute({required int? id, required String page}) {
    if(kIsWeb) {
      // Define MetaSEO object
      MetaSEO meta = MetaSEO();
      // add meta seo data for web app as you want
      meta.ogTitle(ogTitle: 'Post Screen');
      meta.description(description: 'This is Store screen. Here have all information of store');
      meta.keywords(keywords: 'Flutter, Dart, SEO, Meta, Web');
    }
    return '$posts?id=$id&page=$page';
  }
  ...
  // static String getStoreUpdateRoute(int? storeID) => '$storeUpdate?id=$storeID';
  static String getAllRegisteredStoresRoute(int? storeID) => '$allRegisteredStores?id=$storeID';
  static String getAllPostsRoute(int? userID) => '$allPosts?id=$userID';
  static String getAllJobsRoute(int? userID) => '$allJobs?id=$userID';
  ...
  static String getPostCreateRoute() => postCreate;
  static String getJobCreateRoute() => jobCreate;
  ...
  static List<GetPage> routes = [
    ...
    GetPage(name: cityArea, page: ()=> CityAreaScreen(
      fromSignUp: Get.parameters['page'] == signUp, fromHome: Get.parameters['page'] == 'home', route: null,
    )),
    GetPage(name: area, page: ()=> AreaScreen(
      fromSignUp: Get.parameters['page'] == signUp, fromHome: Get.parameters['page'] == 'home', route: null,
    )),
    ...
    GetPage(name: storeUpdate, page: () {
      return getRoute(Get.arguments ?? StoreUpdateScreen(
        store: Store(id: Get.parameters['id'] != 'null' && Get.parameters['id'] != null ? int.parse(Get.parameters['id']!) : null),
        fromModule: Get.parameters['page'] != null && Get.parameters['page'] == 'module',
        slug: Get.parameters['slug'] ?? '',
      ), byPuss: Get.parameters['slug']?.isNotEmpty ?? false);
    ...
    // GetPage(name: updateStore, page: () => getRoute(const StoreUpdateScreen(storeId: Get.parameters['id']))),
    ...
    GetPage(name: webView, page: () => WebViewScreen(),
      binding: BindingsBuilder(
            () {
          Get.lazyPut<WebViewScreen>(() => WebViewScreen(
            title: Get.parameters['webTitle'], // Get the 'webTitle' parameter from the route
            url: Get.parameters['webUrl'], // Get the 'webUrl' parameter from the route
          ));
        },
      ),
    ),
    ...
    // GetPage(name: storeUpdate, page: () => getRoute(StoreUpdateScreen(storeID: int.parse(Get.parameters['id']!)))),
    GetPage(name: allRegisteredStores, page: () => getRoute(RegisteredStoresScreen(storeID: Get.parameters['id']))),
    GetPage(name: allPosts, page: ()=> getRoute(PostListScreen(userID: Get.parameters['id']))),
    GetPage(name: allJobs, page: ()=> getRoute(JobListScreen(userID: Get.parameters['id']))),
    ...
    GetPage(name: postCreate, page: () => PostCreateScreen()),
    GetPage(name: jobCreate, page: () => JobCreateScreen()),
