...
class HomeScreen extends StatefulWidget {
  const HomeScreen({Key? key, this.area}) : super(key: key);
  final area;
...
class _HomeScreenState extends State<HomeScreen> {
  ...
  Future<void> getSelectedArea() async {
    SharedPreferences prefs = await SharedPreferences.getInstance();
    String? selectedArea = prefs.getString('selectedArea');
    if (selectedArea != null) {
      // Use the selectedArea as needed
          ...
          child: RefreshIndicator(
            ...
            Theme1HomeScreen(
              ...
              slivers: [
                  ...
                  title: Center(child: Container(
                    ...
                    child: Row(children: [
                      ...
                      Expanded(child: InkWell(
                        ...
                        onTap: () {
                          Get.offNamed(RouteHelper.getCityAreaRoute('Home'));
                          // _showPopup(context); // Call the function to show the popup
                        },
                ...
                /// Main Module Selection Screen (After Splash Screen)
                SliverToBoxAdapter(
