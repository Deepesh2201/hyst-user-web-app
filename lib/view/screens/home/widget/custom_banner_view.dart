...
class CustomBannerView extends StatelessWidget {
  ...
  const CustomBannerView({Key? key, required this.isFeatured}) : super(key: key);

  @override
  Widget build(BuildContext context) {

    return GetBuilder<CustomBannerController>(builder: (customBannerController) {
      List<String?>? bannerList = customBannerController.bannerImageList;
      List<dynamic>? bannerDataList = isFeatured ? customBannerController.featuredBannerDataList : customBannerController.bannerDataList;
              ...
              child: CarouselSlider.builder(
                options: CarouselOptions(
                  ...
                  onPageChanged: (index, reason) {
                    customBannerController.setCurrentIndex(index, true);
                  },
                ),
            ...
            Row(
              ...
              children: bannerList.map((bnr) {
                ...
                return TabPageSelectorIndicator(
                  backgroundColor: index == customBannerController.currentIndex ? Theme.of(context).primaryColor
                      : Theme.of(context).primaryColor.withOpacity(0.5),
                  borderColor: Theme.of(context).colorScheme.background,
                  size: index == customBannerController.currentIndex ? 10 : 7,
                );
              }).toList(),
            ),
