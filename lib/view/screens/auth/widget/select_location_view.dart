...
class _SelectLocationViewState extends State<SelectLocationView> {
  ...
  Widget build(BuildContext context) {
    return GetBuilder<AuthController>(builder: (authController) {
      ...
      List<DropdownItem<String>> zoneList = [
        DropdownItem(value: 'India', child: Text('India')),
        DropdownItem(value: 'UK', child: Text('UK')),
        DropdownItem(value: 'USA', child: Text('USA')),
      ];
  ...
  Widget webView(AuthController authController, List<DropdownItem<String>> zoneList) {
    return Row(children: [
  ...
  Widget zoneSection(AuthController authController, List<DropdownItem<String>> zoneList) {
    return Container(
      ...
      child: CustomDropdown<String>(
        onChange: (String? value, int index) {
          authController.updateSelectedZone(value!); // Update the selected zone in your controller
        },
        ...
        child: Padding(
          ...
          child: Obx(
                () => Text(
              authController.selectedZone.value.isEmpty ? 'select_zone'.tr : authController.selectedZone.value,
              // You may want to replace the default value above with the appropriate value
            ),
          ),
        ),
      ),
