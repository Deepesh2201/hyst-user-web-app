...
class SignInScreenState extends State<SignInScreen> {
                              ...
                              child: Column(
                                ...
                                children: [
                                  ...
                                  CustomButton(
                                    ...
                                    onPressed: () => _login(authController, '+44'!),
  ...
  void _loginGuest(AuthController authController, String countryDialCode) async {
  ...
  void skipButtonPressed() {
    // Implement the action to be performed when the "Skip" button is pressed.
    // You can navigate to another screen or perform any other desired action.
  }
}
