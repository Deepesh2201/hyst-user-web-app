...
import 'ShiningDiscountTag.dart';
import 'StarRatingPopup.dart';
  ...
  Widget build(BuildContext context) {
    ...
    return Column(children: [
      ...
      if (ResponsiveHelper.isDesktop(context)) IntrinsicHeight(
              ...
              InkWell(
                ...
                child: Column(children: [
                  Row(children: [
                    ...
                    const SizedBox(width: Dimensions.paddingSizeExtraSmall),
                    // Text(
                    //   store!.ratingCount!.toStringAsFixed(1),
                    //   style: robotoMedium.copyWith(
                    //       fontSize: Dimensions.fontSizeSmall, color: textColor),
                    // ),
                  ]),
              ...
              InkWell(
                onTap: () async {
                  String? googleMapsUrl = store?.map_location_link;
              ...
              /// Submit New Star Rating.
              GestureDetector(
                onTap: () {
                  // Show the StarRatingPopup when tapped
                  showDialog(
                    context: context,
                    builder: (BuildContext context) {
                      ...
                      String storeID = store!.id.toString(); // Convert int to String
                      return StarRatingPopup(storeID: storeID);
                    },
                  );
                },
                child: Column(
              ...
              // ShiningDiscountTag(percentage: '60'), // Change '60' to your actual discount percentage
              (store!.delivery! && store!.freeDelivery!)
                  ? const Expanded(child: SizedBox())
                  : const SizedBox(),
              (store!.delivery! && store!.freeDelivery!)
