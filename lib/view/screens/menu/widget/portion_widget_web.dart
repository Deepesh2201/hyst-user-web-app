...
class PortionWidgetWeb extends StatelessWidget {
  final String icon;
  final String title;
  final bool hideDivider;
  final String route; // Define the route parameter
  final String? suffix;
  final VoidCallback? onTap; // Define the onTap parameter

  const PortionWidgetWeb({
    Key? key,
    required this.icon,
    required this.title,
    required this.route,
  ...
  Widget build(BuildContext context) {
    return InkWell(
      onTap: onTap, // Use the onTap parameter for handling taps
      child: Container(
