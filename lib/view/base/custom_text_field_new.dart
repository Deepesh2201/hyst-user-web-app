...
class CustomTextFieldState extends State<CustomTextFieldNew> {
  ...
  Widget build(BuildContext context) {
    return Column(
      ...
      children: [
        ...
        widget.initialValue != null ? Text(widget.initialValue, style: robotoRegular.copyWith(fontSize: Dimensions.fontSizeSmall)) : const SizedBox(),
        SizedBox(height: widget.initialValue !=null ? ResponsiveHelper.isDesktop(context) ? Dimensions.paddingSizeDefault : Dimensions.paddingSizeExtraSmall : 0),
