...
class AppConstants {
  static const String appName = 'High Street';
  static const double appVersion = 2.3;
  static const String packageId = 'com.dgldigital.hyst';

  static const String fontFamily = 'Roboto';
  static const bool payInWevView = false;
  static const int balanceInputLen = 10;

  static const String baseUrl = 'https://backend.hyst.uk';
  static const String mainBaseUrl = 'https://hyst.uk/';
  static const String aboutUsUrl = 'about_us.html';
  static const String termsConditionsUrl = 'terms_conditions.html';
  static const String privacyPolicyUrl = 'privacy_policy.html';
  static const String accountDeleteUrl = 'delete_account.html';
  // static const String baseUrl = 'https://cute-rings-take.loca.lt';
  ...
  static const String subCategoriesUri = '/api/v1/category/subcategories/';
  static const String categoryItemUri = '/api/v1/categories/items/';
  static const String categoryStoreUri = '/api/v1/categories/stores/';
  static const String storeReviewNew = '/api/v1/store/reviews/';
  static const String storeReviewSubmitNew = '/api/v1/store/reviews/submit';
  ...
  static const String storeRegisterUri = '/api/v1/vendor/business/save';
  static const String postCreateUri = '/api/v1/vendor/posts/save';
  static const String postListUri = '/api/v1/vendor/posts/list';
  static const String postDetailsUri = '/api/v1/vendor/posts/edit';
  static const String jobCreateUri = '/api/v1/vendor/vacancies/save';
  static const String jobListUri = '/api/v1/vendor/vacancies/list';
  static const String jobDetailsUri = '/api/v1/vendor/vacancies/edit';
  static const String allRegisteredStoreByUserUri = '/api/v1/vendor/business/list';
  static const String storeUpdateDetailsUri = '/api/v1/vendor/business/edit';
  ...
  // Newly added APIs - For location of user
  static const String countriesListUri = '/api/v1/countries/list';
  static const String mainCategoriesListUri = '/main/categories';
  static const String statesListUri = '/states/bycountryid/';
  static const String cityListUri = '/cities/bystateid';
  static const String areaListUri = '/areas/bycityid/';
