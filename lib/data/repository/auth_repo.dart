...
import 'package:sixam_mart/data/model/body/job_body.dart';
...
import '../model/body/post_body.dart';
...
class AuthRepo {
  ...
  Future<Response> registerStore(StoreBody store, XFile? logo, XFile? cover, XFile? offer) async {

    return apiClient.postMultipartData(
      AppConstants.storeRegisterUri, store.toJson(), [MultipartBody('logo', logo), MultipartBody('cover_photo', cover), MultipartBody('offer_photo', offer)],
    );
  }
  Future<Response> createPost(PostBody post, XFile? pic1, XFile? pic2, XFile? pic3, XFile? pic4) async {

    return apiClient.postMultipartData(
      AppConstants.postCreateUri, post.toJson(), [MultipartBody('pic1', pic1), MultipartBody('pic2', pic2), MultipartBody('pic3', pic3),MultipartBody('pic4', pic4)],
    );
  }
  Future<Response> createJob(JobBody job) async {

    return apiClient.postMultipartData(
      AppConstants.jobCreateUri, job.toJson(), [],
    );
  }
