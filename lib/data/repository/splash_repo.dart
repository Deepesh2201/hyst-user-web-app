...
class SplashRepo {
  ...
  Future<Response> getCities({Map<String, String>? headers}) async {
    return await apiClient.getData(AppConstants.cityListUri, headers: headers);
  }

  Future<Response> getAreas({Map<String, String>? headers, int? stateId}) async {
    print("testdata");
    return await apiClient.getData('${AppConstants.areaListUri}$stateId', headers: headers);
  }
