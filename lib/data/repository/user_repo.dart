...
class UserRepo {
  ...
  Future<Response> storereviewsratings(UserInfoModel userInfoModel, ratings, description, storeId) async {
    return await apiClient.postData(AppConstants.storeReviewSubmitNew, {'userId':userInfoModel.id, 'storeId':storeId, 'ratings': ratings,'reviews':description});
  }
